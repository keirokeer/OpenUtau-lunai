...
namespace OpenUtau.Core.Ustx {
    public class UCurve {
        ...
        /// <summary>
        /// Same stroke algorithm as upstream OpenUtau <c>UCurve.Set</c>, with
        /// <paramref name="emptyValue"/> for track/custom defaults and clearing
        /// erase-breaks under the painted segment.
        /// </summary>
